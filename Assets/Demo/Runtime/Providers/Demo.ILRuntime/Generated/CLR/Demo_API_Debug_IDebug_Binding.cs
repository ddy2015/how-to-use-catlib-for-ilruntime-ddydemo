...
{
    unsafe class Demo_API_Debug_IDebug_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(Demo.API.Debug.IDebug);
            ...
            app.RegisterCLRCreateArrayInstance(type, s => new Demo.API.Debug.IDebug[s]);
        ...
        static StackObject* Log_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Demo.API.Debug.IDebug instance_of_this_method = (Demo.API.Debug.IDebug)typeof(Demo.API.Debug.IDebug).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            __intp.Free(ptr_of_this_method);
